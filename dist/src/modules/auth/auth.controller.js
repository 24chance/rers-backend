...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Log in and receive a JWT access token' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Verify account with the 6-digit OTP' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Account verified.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Reset token generated.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)('skip-first-login'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Dismiss first-login password change prompt' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'First login flag cleared.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "skipFirstLogin", null);
