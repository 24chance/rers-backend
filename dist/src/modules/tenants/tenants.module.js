...
const user_provisioning_module_1 = require("../../common/user-provisioning/user-provisioning.module");
...
exports.TenantsModule = TenantsModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, user_provisioning_module_1.UserProvisioningModule],
