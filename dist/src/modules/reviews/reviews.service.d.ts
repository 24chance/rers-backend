...
export declare class ReviewsService {
    ...
    private findReviewById;
    private openReviewFromAssignmentId;
    startReview(applicationId: string, reviewerId: string): Promise<any>;
    openReviewForAssignment(assignmentId: string, reviewerId: string): Promise<any>;
    ...
    findAssignmentsForReviewer(reviewerId: string): Promise<any[]>;
