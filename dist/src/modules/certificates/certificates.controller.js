...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get certificate for an application (authenticated)' }),
    (0, swagger_1.ApiParam)({ name: 'applicationId', description: 'Application UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Certificate returned.' }),
...
], CertificatesController.prototype, "findByApplication", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)('verify/:token'),
    (0, swagger_1.ApiOperation)({ summary: 'Verify a certificate by token (public)' }),
    (0, swagger_1.ApiParam)({ name: 'token', description: 'Verification token (UUID)' }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Get)('application/:applicationId/download'),
    (0, swagger_1.ApiOperation)({ summary: 'Download certificate for an application' }),
    (0, swagger_1.ApiParam)({ name: 'applicationId', description: 'Application UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Certificate download info returned.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Certificate not found.' }),
    __param(0, (0, common_1.Param)('applicationId')),
